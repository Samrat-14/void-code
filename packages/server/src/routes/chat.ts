import { MessageStatus, type Role, Mode } from "@voidcode/database/enums";
import z from "zod";
import { isSupportedChatModel, resolveChatModel } from "../lib/models";
import { zValidator } from "@hono/zod-validator";
import { streamSSE } from "hono/streaming";
import { streamText as aiStreamText, stepCountIs, type LanguageModelUsage } from "ai";
import {
...
function getResumableUserMessage(messages: { role: Role; model: string; mode: Mode }[]) {
